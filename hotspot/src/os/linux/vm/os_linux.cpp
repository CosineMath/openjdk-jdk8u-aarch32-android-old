...
# include <fcntl.h>
# include <string.h>
# include <sys/syscall.h>     //android_patch
# include <sys/sysinfo.h>
#ifndef __UCLIBC__
//# include <gnu/libc-version.h>      //android_patch 
#endif
# include <sys/ipc.h>
//# include <sys/shm.h>       //android_patch
# include <link.h>
# include <stdint.h>
# include <inttypes.h>
# include <sys/ioctl.h>
...
#undef STRFY
  ...
  */
  ...
  os::Linux::set_glibc_version("glibc 2.x 2.x");
...
void os::Linux::clock_init() {
  ...
  //android_patch : Although it is supposed to be, I dont like it! XD
  /*
...
bool os::dll_address_to_library_name(address addr, char* buf,
  ...
  data.buflen = buflen;
  data.base = NULL;
  int rslt = 0;  //dl_iterate_phdr(address_to_library_name_callback, (void *)&data);  //android_patch : No dl_iterate_phdr available
...
void * os::dll_load(const char *filename, char *ebuf, int ebuflen)
{
  ...
  #endif
  //android_patch : We don't need to define all architectures. Only target architecture is necessary.
  static const arch_t arch_array[]={
    {EM_386,         EM_386,     ELFCLASS32, ELFDATA2LSB, (char*)"IA 32"},
    {EM_486,         EM_386,     ELFCLASS32, ELFDATA2LSB, (char*)"IA 32"},
    //{EM_IA_64,       EM_IA_64,   ELFCLASS64, ELFDATA2LSB, (char*)"IA 64"}, //android_patch
    //{EM_X86_64,      EM_X86_64,  ELFCLASS64, ELFDATA2LSB, (char*)"AMD 64"},  //android_patch
...
*/  //android_patch end
    ...
    //{EM_S390,        EM_S390,    ELFCLASSNONE, ELFDATA2MSB, (char*)"IBM System/390"},    //android_patch
    {EM_ALPHA,       EM_ALPHA,   ELFCLASS64, ELFDATA2LSB, (char*)"Alpha"},
    //{EM_MIPS_RS3_LE, EM_MIPS_RS3_LE, ELFCLASS32, ELFDATA2LSB, (char*)"MIPSel"},   //android_patch
...
void os::jvm_path(char *buf, jint buflen) {
  ...
  if (ret && dli_fname[0] != '\0') {
    ...
    if (access(rp, F_OK) != 0){
      ...
      assert(java_home_var != NULL, "cannot find directory for dlls");
...
//android_patch : No dlvsym available.
...
void* os::Linux::libnuma_v2_dlsym(void* handle, const char* name) {
  return NULL;//dlvsym(handle, name, "libnuma_1.2");    //android_patch
}
...
//android_patch : shm* are not available.
/*
#ifndef SHM_HUGETLB
...
bool os::Linux::release_memory_special_shm(char* base, size_t bytes) {
  ...
  //return shmdt(base) == 0;    //android_patch : shm* are not available.
  return true;
}
...
//android_patch
// No cpu_set_t available for Android.
/*
...
int os::Linux::active_processor_count() {
  ...
  //Although it is supposed to be, I dont like it! XD
  /*
...
int os::open(const char *path, int oflag, int mode) {
  ...
  fd = ::open(path, oflag, mode);    //android_patch
  if (fd == -1) return -1;
...
int os::create_binary_file(const char* path, bool rewrite_existing) {
  ...
  return ::open(path, oflags, S_IREAD | S_IWRITE);   //android_patch
}
...
//android_patch : load average cannot be obtained.
  return -1;
/*
#ifndef __UCLIBC__
