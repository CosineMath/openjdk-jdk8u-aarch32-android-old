...
#include <ctype.h>
#include <locale.h>
//#include <langinfo.h>   //android_patch
//#include <iconv.h>      //android_patch
...
{
    //android_patch : Just copy without any convertion.
...
//Assume that we dont need to do any convertion.
